...
declare module google {
    export interface GoogleApis {
        ...
        adsense(version: 'v1.2'): adsense.v1_2.Adsense;
    }
        ...
        namespace v1_2 {
            export interface Adsense {
                ...
                'accounts': {
                    ...
                    'reports': {
                        'generate': (parameters: {'accountId': string, 'currency'?: string, 'dimension'?: string, 'endDate': string, 'filter'?: string, 'locale'?: string, 'maxResults'?: number, 'metric'?: string, 'sort'?: string, 'startDate': string, 'startIndex'?: number}, callback: (error: any, body: AdsenseReportsGenerateResponse, response: any) => void) => Request;
