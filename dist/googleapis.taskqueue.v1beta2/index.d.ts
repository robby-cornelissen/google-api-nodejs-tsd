        ...
        namespace v1beta2 {
            export interface Taskqueue {
                ...
                'tasks': {
                    ...
                    'insert': (parameters: { [key: string]: any; 'project': string, 'taskqueue': string}, callback: (error: any, body: Task, response: any) => void) => Request;
                    'lease': (parameters: { [key: string]: any; 'groupByTag'?: boolean, 'leaseSecs': number, 'numTasks': number, 'project': string, 'tag'?: string, 'taskqueue': string}, callback: (error: any, body: Tasks, response: any) => void) => Request;
                    'list': (parameters: { [key: string]: any; 'project': string, 'taskqueue': string}, callback: (error: any, body: Tasks2, response: any) => void) => Request;
                    'patch': (parameters: { [key: string]: any; 'newLeaseSeconds': number, 'project': string, 'task': string, 'taskqueue': string}, callback: (error: any, body: Task, response: any) => void) => Request;
                    'update': (parameters: { [key: string]: any; 'newLeaseSeconds': number, 'project': string, 'task': string, 'taskqueue': string}, callback: (error: any, body: Task, response: any) => void) => Request;
                };
