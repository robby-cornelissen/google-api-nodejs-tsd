...
declare namespace google {
    export interface GoogleApis {
        ...
        dfareporting(version: 'v2.7'): dfareporting.v2_7.Dfareporting;
    }
        ...
        namespace v2_7 {
            export interface Dfareporting {
                ...
                'directorySites': {
                    ...
                    'list': (parameters: { [key: string]: any; 'acceptsInStreamVideoPlacements'?: boolean, 'acceptsInterstitialPlacements'?: boolean, 'acceptsPublisherPaidPlacements'?: boolean, 'active'?: boolean, 'countryId'?: string, 'dfp_network_code'?: string, 'ids'?: string, 'maxResults'?: number, 'pageToken'?: string, 'parentId'?: string, 'profileId': string, 'searchString'?: string, 'sortField'?: string, 'sortOrder'?: string}, callback: (error: any, body: DirectorySitesListResponse, response: any) => void) => Request;
                };
