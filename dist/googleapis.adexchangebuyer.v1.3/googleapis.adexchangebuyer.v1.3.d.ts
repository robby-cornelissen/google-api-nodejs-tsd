        ...
        namespace v1_3 {
            export interface Adexchangebuyer {
                ...
                'creatives': {
                    ...
                    'list': (parameters: {'accountId'?: number, 'buyerCreativeId'?: string, 'maxResults'?: number, 'pageToken'?: string, 'statusFilter'?: string}, callback: (error: any, body: CreativesList, response: any) => void) => Request;
                };
                'directDeals': {
                    'get': (parameters: {'id': string}, callback: (error: any, body: DirectDeal, response: any) => void) => Request;
