...
declare namespace google {
    export interface GoogleApis {
        ...
        deploymentmanager(version: 'alpha'): deploymentmanager.alpha.Deploymentmanager;
    }
    ...
    namespace deploymentmanager {
        namespace alpha {
            export interface Deploymentmanager {
                ...
                'types': {
                    'delete': (parameters: { [key: string]: any; 'project': string, 'type': string}, callback: (error: any, body: Operation, response: any) => void) => Request;
                    'get': (parameters: { [key: string]: any; 'project': string, 'type': string}, callback: (error: any, body: Type, response: any) => void) => Request;
                    'insert': (parameters: { [key: string]: any; 'project': string}, callback: (error: any, body: Operation, response: any) => void) => Request;
                    ...
                    'patch': (parameters: { [key: string]: any; 'project': string, 'type': string}, callback: (error: any, body: Operation, response: any) => void) => Request;
                    'update': (parameters: { [key: string]: any; 'project': string, 'type': string}, callback: (error: any, body: Operation, response: any) => void) => Request;
                };
            ...
            export interface Deployment {
                ...
                'name': string;
                'operation': Operation;
                'outputs': DeploymentOutputsEntry[];
                'selfLink': string;
            ...
            export interface DeploymentOutputsEntry {
                'key': string;
                'value': string;
            }
