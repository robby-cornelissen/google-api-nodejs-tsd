...
declare namespace google {
    export interface GoogleApis {
        ...
        oslogin(version: 'v1beta'): oslogin.v1beta.Oslogin;
    }
            ...
            export interface Oslogin {
                ...
                'users': {
                    ...
                    'sshPublicKeys': {
                        ...
                        'patch': (parameters: { [key: string]: any; 'name': string, 'updateMask'?: string}, callback: (error: any, body: SshPublicKey, response: any) => void) => Request;
