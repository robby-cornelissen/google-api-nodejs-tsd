...
declare module google {
    export interface GoogleApis {
        ...
        dfareporting(version: 'v2.5beta1'): dfareporting.v2_5beta1.Dfareporting;
    }
    ...
    namespace dfareporting {
        namespace v2_5beta1 {
            export interface Dfareporting {
                ...
                'conversions': {
                    'batchinsert': (parameters: {'profileId': string}, callback: (error: any, body: ConversionsBatchInsertResponse, response: any) => void) => Request;
                };
                'countries': {
                ...
                'dynamicTargetingKeys': {
                    'delete': (parameters: {'name': string, 'objectId': string, 'objectType': string, 'profileId': string}, callback: (error: any, body: any, response: any) => void) => Request;
                    'insert': (parameters: {'profileId': string}, callback: (error: any, body: DynamicTargetingKey, response: any) => void) => Request;
                    'list': (parameters: {'advertiserId'?: string, 'names'?: string, 'objectId'?: string, 'objectType'?: string, 'profileId': string}, callback: (error: any, body: DynamicTargetingKeysListResponse, response: any) => void) => Request;
                };
                'eventTags': {
                    'delete': (parameters: {'id': string, 'profileId': string}, callback: (error: any, body: any, response: any) => void) => Request;
