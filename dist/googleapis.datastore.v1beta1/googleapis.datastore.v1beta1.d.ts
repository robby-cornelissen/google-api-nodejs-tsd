        ...
        namespace v1beta1 {
            export interface Datastore {
                ...
                'datasets': {
                    ...
                    'blindWrite': (parameters: {'datasetId': string}, callback: (error: any, body: BlindWriteResponse, response: any) => void) => Request;
            ...
            export interface BlindWriteRequest {
                'mutation': Mutation;
            }

            export interface BlindWriteResponse {
                'header': ResponseHeader;
