    ...
    namespace pagespeedonline {
        namespace v1 {
            export interface Pagespeedonline {
                ...
                'pagespeedapi': {
                    'runpagespeed': (parameters: {'filter_third_party_resources'?: boolean, 'locale'?: string, 'rule'?: string, 'screenshot'?: boolean, 'strategy'?: string, 'url': string}, callback: (error: any, body: Result, response: any) => void) => Request;
                };
