        ...
        namespace v1_4 {
            export interface Adsense {
                ...
                'accounts': {
                    ...
                    'alerts': {
                        'delete': (parameters: {'accountId': string, 'alertId': string}, callback: (error: any, body: any, response: any) => void) => Request;
                    ...
                    'payments': {
                        'list': (parameters: {'accountId': string}, callback: (error: any, body: Payments, response: any) => void) => Request;
                    };
                    'reports': {
                ...
                'alerts': {
                    'delete': (parameters: {'alertId': string}, callback: (error: any, body: any, response: any) => void) => Request;
