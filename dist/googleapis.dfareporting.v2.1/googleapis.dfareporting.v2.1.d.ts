...
declare module google {
    export interface GoogleApis {
        ...
        dfareporting(version: 'v2.1'): dfareporting.v2_1.Dfareporting;
    }
        ...
        namespace v2_1 {
            export interface Dfareporting {
                ...
                'inventoryItems': {
                    ...
                    'list': (parameters: {'ids'?: string, 'inPlan'?: boolean, 'maxResults'?: number, 'orderId'?: string, 'pageToken'?: string, 'profileId': string, 'projectId': string, 'siteId'?: string, 'sortField'?: string, 'sortOrder'?: string}, callback: (error: any, body: InventoryItemsListResponse, response: any) => void) => Request;
                };
                'landingPages': {
