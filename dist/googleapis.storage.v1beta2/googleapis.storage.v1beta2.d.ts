        ...
        namespace v1beta2 {
            export interface Storage {
                ...
                'buckets': {
                    ...
                    'insert': (parameters: {'project': string, 'projection'?: string}, callback: (error: any, body: Bucket, response: any) => void) => Request;
                    'list': (parameters: {'maxResults'?: number, 'pageToken'?: string, 'project': string, 'projection'?: string}, callback: (error: any, body: Buckets, response: any) => void) => Request;
                    'patch': (parameters: {'bucket': string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'projection'?: string}, callback: (error: any, body: Bucket, response: any) => void) => Request;
                    'update': (parameters: {'bucket': string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'projection'?: string}, callback: (error: any, body: Bucket, response: any) => void) => Request;
                };
                'channels': {
                ...
                'objects': {
                    'compose': (parameters: {'destinationBucket': string, 'destinationObject': string, 'ifGenerationMatch'?: string, 'ifMetagenerationMatch'?: string}, callback: (error: any, body: Object, response: any) => void) => Request;
                    'copy': (parameters: {'destinationBucket': string, 'destinationObject': string, 'ifGenerationMatch'?: string, 'ifGenerationNotMatch'?: string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'ifSourceGenerationMatch'?: string, 'ifSourceGenerationNotMatch'?: string, 'ifSourceMetagenerationMatch'?: string, 'ifSourceMetagenerationNotMatch'?: string, 'projection'?: string, 'sourceBucket': string, 'sourceGeneration'?: string, 'sourceObject': string}, callback: (error: any, body: Object, response: any) => void) => Request;
                    ...
                    'insert': (parameters: {'bucket': string, 'ifGenerationMatch'?: string, 'ifGenerationNotMatch'?: string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'name'?: string, 'projection'?: string}, callback: (error: any, body: Object, response: any) => void) => Request;
                    ...
                    'patch': (parameters: {'bucket': string, 'generation'?: string, 'ifGenerationMatch'?: string, 'ifGenerationNotMatch'?: string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'object': string, 'projection'?: string}, callback: (error: any, body: Object, response: any) => void) => Request;
                    'update': (parameters: {'bucket': string, 'generation'?: string, 'ifGenerationMatch'?: string, 'ifGenerationNotMatch'?: string, 'ifMetagenerationMatch'?: string, 'ifMetagenerationNotMatch'?: string, 'object': string, 'projection'?: string}, callback: (error: any, body: Object, response: any) => void) => Request;
